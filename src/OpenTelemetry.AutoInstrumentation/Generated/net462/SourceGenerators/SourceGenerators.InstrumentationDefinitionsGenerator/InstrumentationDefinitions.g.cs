...
internal static partial class InstrumentationDefinitions
{
    private static NativeCallTargetDefinition[] GetDefinitionsArray()
    {
        ...
        if (tracerSettings.TracesEnabled)
        {
            ...
            {
                nativeCallTargetDefinitions.Add(new("?INTIME", "?INTIME", "?", ["System.Void"], 1, 0, 0, 65535, 65535, 65535, AssemblyFullName, "OpenTelemetry.AutoInstrumentation.Instrumentations.Axal.AxalIntegration"));
            }
