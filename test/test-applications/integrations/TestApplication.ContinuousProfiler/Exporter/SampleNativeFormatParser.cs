        ...
        try
        {
            while (position < read)
            {
                ...
                if (operationCode == OpCodes.StartBatch)
                {
                    ...
                    // TODO Debug logs to measure overhead https://github.com/axal-2024/opentelemetry-dotnet-instrumentation/issues/3205
                ...
                else
                {
                    ...
                    // TODO Debug log to handle unexpected buffer https://github.com/axal-2024/opentelemetry-dotnet-instrumentation/issues/3205
                    /* if (IsLogLevelDebugEnabled)
                    {
